...
import { ModalBackdrop } from '@/components/primitive/modal-backdrop';
...
export const ModalCollection = () => {
	...
	return (
		<Gallery title='Modal' description='A collection of modal components.'>
			<Showcase label='Modal with button trigger'>
				<Button variant='secondary' onClick={button.onOpen}>
					Open modal
				</Button>
				<Modal open={button.open} onClose={button.onClose}>
					<ModalBackdrop>
				...
				<Modal open={label.open} onClose={label.onClose}>
					<ModalBackdrop>
						<ModalContent title='Terms of service' size='lg'>
							<ModalBody>
								<p>
									By using this service you agree to our terms and conditions. We collect minimal
									data necessary to provide the service, and we will never sell your data to third
									parties. You can request deletion of your account and associated data at any time
									by contacting support. Continued use of the service constitutes acceptance of any
