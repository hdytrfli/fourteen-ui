 ...
 * @param children - Optional SlideMenuItem components for submenu
 */
export const SlideMenuItem = ({
	...
	React.useLayoutEffect(() => {
		...
		if (open) {
			gsap.fromTo(
				el,
				{ x: -10, opacity: VALUES.hidden },
				{ x: 0, opacity: VALUES.visible, duration: DURATION.base, ease: EASE.default }
			);
		}
	}, [open, hasSubmenu]);
