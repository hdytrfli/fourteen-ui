 ...
 * @param children - Optional ScaleMenuItem components for submenu
 */
export const ScaleMenuItem = ({
	label,
	variant = 'primary',
	position = 'start',
	icon: Icon,
	...
	React.useLayoutEffect(() => {
		...
		if (open) {
			gsap.fromTo(
				el,
				{ scale: 0.95, opacity: VALUES.hidden },
				{ scale: 1, opacity: VALUES.visible, duration: DURATION.base, ease: EASE.default }
			);
		}
	}, [open, hasSubmenu]);
